...
didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  (void)[navigationController initWithRootViewController:photosTableViewController];
  [navigationController.view setFrame:(CGRect){CGPointZero, {kKYViewWidth, kKYViewHeight}}];
